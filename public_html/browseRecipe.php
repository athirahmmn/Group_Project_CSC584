...
<body>
  <header class="header">
    <nav class="nav">
      <div class="container">
        <ul>
          ...
          <li><a href="browse.html">Browse Recipe</a></li>
    ...
    <div class="recipe-container">
      ...
      <div class="button-position">
        <button class="button button2" onclick="location.href='createNewRecipe.php'"> + Create new recipe</button>
      </div>
  ...
  if (mysqli_num_rows($result) > 0) {
    ...
    while ($row = mysqli_fetch_assoc($result)) {
      ...
      echo '<a href="recipe-description/'.$row['description'].'">';
      echo '<img src="images/'.$row['image_url'].'" alt="'.$row['title'].'">';
      echo '<h3 class="no-link-style">'.$row['title'].'</h3>';
